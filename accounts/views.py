...
def google_login(request):
   scope = GOOGLE_SCOPE_USERINFO        # + "https://www.googleapis.com/auth/drive.readonly" 등 자율적으로 추가
...
def google_callback(request):
    ...
    # code = body['code']
    code = request.GET.get("code")      # query 로 넘어옴
    ...
    try:
        if serializer.is_valid(raise_exception=True):
            ...
            res.set_cookie("refresh-token", refresh_token, httponly=True)
            return res
    except:       # 회원가입이 필요 + APIView가 아니라서 JSonResponse로 반환
